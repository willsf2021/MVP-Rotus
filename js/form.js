...
function submitForm(e) {
  ...
  let alertMessage =
    page == "login"
      ...
      : "Redirecionando para página de autenticação...";
...
function redirectTo(alertContainerEl, page) {
  ...
  setTimeout(() => {
    ...
    if (page == "login") {
      let homeRef = "/home.html";
      window.location.href = `${root}${homeRef}`;
    } else if ((page = "register")) {
      let loginRef = "/login.html";
      window.location.href = `${root}${loginRef}`;
    }
  }, 3000);
}